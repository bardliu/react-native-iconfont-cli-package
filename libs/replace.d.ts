...
export declare const replaceSvgComponents: (content: string, components: Set<string>) => string;
...
export declare const replaceHelper: (content: string) => string;
export declare const replaceNoColor: (content: string) => string;
export declare const replaceSummaryIcon: (content: string, iconName: string) => string;
